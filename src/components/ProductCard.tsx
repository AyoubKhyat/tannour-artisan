        ...
        >
          ...
          <div className="p-5">
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <button onClick={() => addItem(product, product.colors[0].name, product.sizes[0])} className="px-4 py-2 text-xs tracking-[0.15em] uppercase border border-subtle-strong text-accent/70 hover:bg-accent hover:text-white transition-all duration-300" aria-label={`Add ${product.nameFr} to bag`}>Add</button>
            </div>
